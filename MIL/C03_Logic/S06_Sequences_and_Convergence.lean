...
theorem convergesTo_unique {s : ℕ → ℝ} {a b : ℝ}
  ...
  -- search_proof
  -- simp_all only [gt_iff_lt, abs_pos, ne_eq, not_false_eq_true, div_pos_iff_of_pos_left, Nat.ofNat_pos, ge_iff_le,
    -- le_max_iff, le_refl, true_or, or_true, lt_self_iff_false, ε, N]
