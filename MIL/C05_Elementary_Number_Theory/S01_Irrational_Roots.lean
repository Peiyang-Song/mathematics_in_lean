...
example {m n p : ℕ} (coprime_mn : m.Coprime n) (prime_p : p.Prime) : m ^ 2 ≠ p * n ^ 2 := by
  ...
  -- search_proof
  -- subst meq
  -- simp_all only [dvd_mul_left, Nat.dvd_one, one_mul, zero_le, ne_eq, OfNat.ofNat_ne_zero, not_false_eq_true,
  --   pow_left_inj, isUnit_one, IsUnit.dvd, mul_one, Nat.coprime_self, one_pow]
  -- subst this coprime_mn
